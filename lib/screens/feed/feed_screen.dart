...
import '../../providers/story_provider_riverpod.dart';
...
class FeedScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final feedPostsAsync = ref.watch(feedPostsProvider(currentUserId));
    final storiesAsync = ref.watch(userStoriesProvider(currentUserId));
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ref.invalidate(feedPostsProvider(currentUserId));
          ref.invalidate(userStoriesProvider(currentUserId));
        },
        child: feedPostsAsync.when(
